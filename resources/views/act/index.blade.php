                    ...
                    <div class="bg-white-30 rounded-lg shadow-lg">
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col">
                                    <input type="text" value="Rp {{ $acts_pemasukan}}" class="form-control text-right" disabled>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col">
                                ...
                                <div class="col">
                                    <input type="text" value="Rp {{ $acts_pengeluaran}}" class="form-control text-right" disabled>
                                </div>
                            </div>
                    ...
                    <div class="bg-white-30 rounded-lg shadow-lg">
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col">
                                    <input type="text" value="Rp {{ $acts_pemasukan_last }}" class="form-control text-right" disabled>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col">
                                ...
                                <div class="col">
                                    <input type="text" value="Rp {{ $acts_pengeluaran_last}}" class="form-control text-right" disabled>
                                </div>
                            </div>
                            <div class="form-row mt-2">
                                <div class="col">
                                    <input type="text" value="Saldo (Pemasukan - Pengeluaran)" class="form-control" disabled>
                                    <input type="text" value="= Rp {{ $saldo_last }}" class="form-control" disabled>
                                </div>
                            </div>
                        </div>
                    </div>
